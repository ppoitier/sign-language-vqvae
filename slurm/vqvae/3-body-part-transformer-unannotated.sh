#!/bin/bash
# Submission script for Lucia - body-part VQ-VAE training (annotated + unannotated).
#
#SBATCH --job-name=vqvae_body_part_unannotated
...
#SBATCH --account=lsfb
#
#SBATCH --output=./out/3-body-part-transformer-unannotated/%j.out
...
config_file="configs/cluster/body_part_vqvae_unannotated.json"
